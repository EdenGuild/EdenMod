package com.edenguild.bridge.item;
...
public final class WynntilsItemDecoder {
    ...
    public static Optional<DecodedItem> decode(String itemString, String craftedName) {
        ...
        try {
            Object buffer = call(
                    Class.forName("com.wynntils.utils.EncodedByteBuffer"),
                    null,
                    "fromUtf16String",
            ...
            if (errorOr == null || (boolean) call(errorOr, "hasError")) {
                LOGGER.warn(
                        "Wynntils could not decode shared item: {}",
                        errorOr == null ? "no matching decode method" : call(errorOr, "getError"));
                return Optional.empty();
            }
    ...
    private static Optional<DecodedItem> buildCard(Object gearItem) throws ReflectiveOperationException {
        ...
        return Optional.of(
                new DecodedItem(name, tierName, tierColor, typeName, overall, ids, powderSlots));
    }

    private static List<DecodedItem.Identification> buildIdentifications(Object gearItem)
    ...
    private static Map<Object, Object> indexByStatType(Object possibleValues)
            throws ReflectiveOperationException {
    ...
    private static Object invokeDecode(Object model, Object buffer, String craftedName)
            throws ReflectiveOperationException {
        if (model == null) {
            return null;
        }
    ...
    private static Object call(Class<?> cls, Object target, String method, Class<?>[] types, Object... args)
            throws ReflectiveOperationException {
